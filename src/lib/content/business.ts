// Conținutul cursului Arhitectura Afacerii · Business.
// Extras din vechiul src/lib/data.ts la trecerea platformei pe două niveluri.
// ID-urile ('m-0', 'l-1-1', 'e-0-1') NU se schimbă: sunt deja scrise în datele elevilor.
...
/** Evenimentele live ale cursului Business (Zoom de grup, workshopuri). */
export const BUSINESS_LIVE_EVENTS: LiveEvent[] = [
  {
    id: 'ev-1',
    type: 'zoom',
