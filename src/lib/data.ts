    ...
    lessons: [
      {
        id: 'l-5-1',
        module_id: 'mod-5',
        title: 'Ce e delegarea reală: responsabilitate și autoritate',
        description:
          'Delegarea reală are 3 ingrediente: responsabilitate pentru un rezultat, autoritate de decizie și un proces scris. Fără toate trei, nu ai delegat — ai mutat sarcina lângă tine.',
        video_url: 'https://youtu.be/lNmLbQYr-cE',
        pdf_url: '',
        duration_min: 21,
        order_index: 1,
        is_published: true,
      },
      {
        id: 'l-5-2',
        module_id: 'mod-5',
        title: 'Cum ieși treptat din operațional, fără haos?',
        description:
          'Formula retragerii: alegi procesul (3 criterii), transferi complet (cunoștințe, acces, KPI, supraveghere), confirmi în rodaj și faci pasul înapoi când cifra e bună constant, fără tine.',
        video_url: 'https://www.youtube.com/watch?v=3tKMRzJsbAY',
        pdf_url: '',
        duration_min: 19,
        order_index: 2,
        is_published: true,
      },
      {
        id: 'l-5-3',
        module_id: 'mod-5',
        title: 'Greșelile controlate și corectarea sistemului',
        description:
          'Dacă echipa ta nu greșește niciodată, înseamnă că nu ai delegat. Cum treci de la „cine e vinovat" la „ce reparăm în sistem" — cu cei 5 de ce și registrul de greșeli.',
        video_url: 'https://www.youtube.com/watch?v=OWdOX0LMoZU',
        pdf_url: '',
        duration_min: 28,
        order_index: 3,
        is_published: true,
      },
      {
        ...
        description:
          'Săptămâna 7 · Lecția 18. Treci fiecare rol prin testul celor 3 ingrediente (rezultat, autoritate, proces scris) și descoperi unde ai delegat cu adevărat și unde doar ai mutat sarcini.',
        video_url: '',
        duration_min: 25,
        order_index: 4,
        is_published: true,
        type: 'exercise',
        exercise_id: 'ex-7-1-trei-ingrediente',
      },
      {
        id: 'l-5-ex-2',
        module_id: 'mod-5',
        ...
        description:
          'Săptămâna 7 · Lecția 19. Construiești planul de retragere pentru un singur proces: alegerea prin cele 3 criterii, transferul complet, rodajul și momentul pasului înapoi. Companion: Documentul 10.',
        video_url: '',
        duration_min: 30,
        order_index: 5,
        is_published: true,
        type: 'exercise',
        exercise_id: 'ex-7-2-plan-retragere',
      },
      {
        id: 'l-5-ex-3',
        module_id: 'mod-5',
        ...
        description:
          'Săptămâna 7 · Lecția 20. Iei o greșeală reală din firma ta și o treci prin cei 5 de ce până la cauza din sistem + registrul de greșeli. Companion: Documentul 11.',
        video_url: '',
        duration_min: 30,
        order_index: 6,
        is_published: true,
        type: 'exercise',
        exercise_id: 'ex-7-3-cinci-de-ce',
      },
    ],
    exercises: [
      {
    ...
    lessons: [
      {
        ...
        description:
          'Când treci de la constructor la conducător de sistem. Diferența dintre manager de oameni și manager de sistem.',
      ...
      },
      {
        ...
        description:
          'Săptămâna 8 · Lecția 21. Testezi un flux complet de la lead la încasare, treci prin cele 6 semne ale recepției reușite, faci planul de întărire și îți scrii noul rol de proprietar. Companion: Documentul 12.',
        video_url: '',
        duration_min: 35,
        order_index: 2,
        is_published: true,
        type: 'exercise',
        exercise_id: 'ex-8-1-receptia-finala',
      },
      {
        id: 'l-6-2',
        module_id: 'mod-6',
        ...
        description:
          'Cadența de conducere a firmei: ședința săptămânală, ciclul de execuție și planul care le leagă.',
      ...
      },
      {
        ...
        description:
          'Săptămâna 8 · Lecția 22. Îți construiești ședința săptămânală cu agendă fixă, analiza lunară cu cele 4 întrebări, blocurile din calendar (inclusiv cele 2 ore de gândire) și regula de disciplină. Companion: Documentul 13.',
        video_url: '',
        duration_min: 30,
        order_index: 4,
        is_published: true,
        type: 'exercise',
        exercise_id: 'ex-8-2-ritmul-de-conducere',
      },
      {
        id: 'l-6-3',
        module_id: 'mod-6',
        ...
        description:
          'Creștere fără haos: unde se rupe sistemul la scalare și cum evaluezi corect unde ai ajuns.',
      ...
      },
      {
        ...
        description:
          'Săptămâna 8 · Lecția 23. Identifici gâtul de sticlă din tablou, alegi felul de creștere potrivit sistemului tău și faci retrospectiva celor 8 săptămâni.',
        video_url: '',
        duration_min: 30,
        order_index: 6,
        is_published: true,
        type: 'exercise',
        exercise_id: 'ex-8-3-scalarea-si-inchiderea',
      },
    ],
    exercises: [
      {
        ...
        title: 'Recepția finală a firmei tale',
        description:
          'Testul de flux (de la lead la încasare), cele 6 semne ale recepției reușite, harta de întărire pentru fiecare semn nebifat și fișa noului tău rol de proprietar.',
        order_index: 1,
      },
      {
        id: 'e-6-2',
        ...
        title: 'Ritmul meu de conducere',
        description:
          'Ședința săptămânală cu agendă fixă în 4 pași, analiza lunară cu cele 4 întrebări, blocurile din calendar și regula de disciplină împotriva alunecării în operațional.',
        order_index: 2,
      },
      {
        id: 'e-6-3',
        ...
        title: 'Unde ai ajuns și ce crești primul',
        description:
          'Gâtul de sticlă citit din tablou, felul de creștere ales (volum, oameni în plus sau replicare) și retrospectiva celor 8 săptămâni.',
        order_index: 3,
      },
    ],
  },
