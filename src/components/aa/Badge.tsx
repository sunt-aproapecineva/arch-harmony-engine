...
const variantStyles: Record<BadgeVariant, React.CSSProperties> = {
  ...
  success: { background: 'rgba(74,222,128,0.12)',  color: 'var(--ok)',  borderColor: 'rgba(74,222,128,0.25)' },
  warning: { background: 'rgba(251,191,36,0.12)',  color: 'var(--warn)',  borderColor: 'rgba(251,191,36,0.25)' },
  danger:  { background: 'rgba(248,113,113,0.12)', color: 'var(--error)',  borderColor: 'rgba(248,113,113,0.25)' },
};
